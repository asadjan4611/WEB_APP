const styles = {
    ...
    button: 'rounded-md w-[150px] bg-black h-[50px] my-3 flex items-center justify-center  cursor-pointer',
    circleButtton: 'w-[120px] rounded-[150px] bg-black h-[50px] my-3 flex items-center justify-center  cursor-pointer',
